        ...
        {status === "authenticated" ? (
          <Card className='w-fulltext-center p-10'>
            <CardContent className='flex flex-col justify-center items-center'>
              <CardHeader className="text-lg tracking-wider text-slate-800">HARMONIA</CardHeader>
          ...
          <Card className='w-full max-w-md text-center p-10'>
            <CardContent className='flex flex-col justify-center items-center'>
              <CardDescription className='text-xl font-bold my-3'>Loading...</CardDescription>
              <BeatLoader color="#1E293B" size={15} />
            </CardContent>
          </Card>
        ) : (
          <Card className='w-full max-w-md text-center p-10'>
            <CardContent className='flex flex-col justify-center items-center'>
              <CardDescription >We don't think you've signed in yet.</CardDescription>
